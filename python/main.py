...
Place the DDNTA file in the current working directory and name it "ddnta.pdf". Run this script.
"""
...
def find_pages(reader: PdfReader) -> tuple[list[tuple[str, int, int]], int]:

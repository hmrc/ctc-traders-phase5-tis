---
title: MESSAGE CC028C
description: Details of the MESSAGE CC028C message structure, conditions and rules
weight: 28
---
#MESSAGE CC028C
##Properties
<table class="table width-min-100">
 ...
 <tr>
  ...
  <td>
   Office of Departure notifies that declaration is accepted.
  </td>
 </tr>
 <tr>
  <td class="label">
...
<table class="table">
 ...
 <tr class="indent-2">
  <td class="code">
   --declarationAcceptanceDateAndTime
  </td>
  <td>
   Declaration acceptance date and time
  </td>
  <td>
  </td>
  <td>

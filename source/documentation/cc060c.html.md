---
title: MESSAGE CC060C
description: Details of the MESSAGE CC060C message structure, conditions and rules
weight: 60
---
#MESSAGE CC060C
##Properties
<table class="table width-min-100">
 ...
 <tr>
  ...
  <td>
   If declaration control is ordered at departure, Office of Departure informs Holder of the procedure/Authorised consignor about the ordered control. In case of simplified procedure, an automatic release process is stopped until control is finished.
  </td>
 </tr>
 <tr>
  <td class="label">
...
<table class="table">
 ...
 <tr class="indent-2">
  ...
  <td>
   <a href="metatypes.html#UCC_Patterns_template_ControlNotificationDateAndTimeContentType" target="MsgCons">
 ...
 <tr class="indent-2">
  ...
  <td>
   <a href="metatypes.html#UCC_Patterns_template_NotificationTypeContentType" target="MsgCons">
  ...
  <td>
   <a href="codelists.html#CSRD2_Codelists_NCTS_NotificationType" target="MsgCons">
    NotificationType ()
   </a>
  </td>
  <td>
 ...
 <tr class="indent-2">
  <td class="code">
   --controlNotificationText
  </td>
  <td>
   Control decision notification text
  </td>
  <td>
  </td>
  <td>
